...
vim.keymap.set("n", "q", function() require("trouble").toggle() end)
...
vim.keymap.set('n', '<leader>fa', ':Telescope find_files hidden=true<cr>', { desc = '[S]earch by [G]rep on Git Root' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>rr', '! run', '[R]un')
  nmap('<leader>ca', vim.lsp.buf.code_action, '[C]ode [A]ction')
  nmap('<leader>x', ':TroubleToggle<CR>', 'quickfix')
  nmap('q', ':TroubleToggle<CR>', 'quickfix')
  ...
  -- nmap('<leader>wl', :, '[W]orkspace [L]ist Folders')
